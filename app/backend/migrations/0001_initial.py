# Generated by Django 4.2 on 2024-06-20 11:16
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Task',
            fields=[
                ('task_id', models.BigAutoField(primary_key=True, serialize=False, verbose_name='Veranstaltungstag')),
                ...
                ('comment', models.TextField(blank=True, verbose_name='Kommentar')),
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.event', verbose_name='Veranstaltungstag')),
            ],
            options={

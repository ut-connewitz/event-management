# Generated by Django 4.2 on 2024-08-19 14:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_name', models.CharField(help_text='Der Name der Vorlage erscheint als Name der daraus erstellten Veranstaltungen und kann dabei optional um einen Veranstaltungstitel erweitert werden.', max_length=50, verbose_name='Name der Vorlage')),
        ...
        migrations.AddField(
            model_name='event',
            name='series',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.eventseries', verbose_name='Veranstaltungsvorlage'),
        ),
        migrations.AddField(
